                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>
                                            <button class="btn-sm bg-teal btn-block" type="button">Database Normalization</button>
                                        </td>
                                        <td>
                                            <span class="badge bg-teal">
                                                Working
                                        ...
                                        <td>Cras congue elit a nisi imperdiet sollicitudin. Proin varius enim sed erat tempus, at tincidunt magna semper. Vivamus erat mauris, sollicitudin at varius quis, imperdiet at tortor. Ut imperdiet turpis vitae ornare egestas. Nunc lacinia erat magna, id egestas mi commodo quis. Nunc tincidunt neque a ipsum venenatis, vitae porta lacus laoreet. Nulla venenatis quis magna in pharetra. Maecenas lobortis augue accumsan neque semper euismod. In eu lacus sapien. 
                                        </td>
                                        <td>
                                            <center>
                                                <div class="image image-circle">
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>
                                            <button class="btn-sm bg-teal btn-block" type="button">Lorem Ipsum</button>
                                        </td>
                                        <td>
                                        ...
                                        <td>Vivamus erat mauris, sollicitudin at varius quis, imperdiet at tortor. Ut imperdiet turpis vitae ornare egestas. Nunc lacinia erat magna, id egestas mi commodo quis. Nunc tincidunt neque a ipsum venenatis, vitae porta lacus laoreet. Nulla venenatis quis magna in pharetra. Maecenas lobortis augue accumsan neque semper euismod. In eu lacus sapien. 
                                        </td>
                                        <td>
                                            <center>
                                                <div class="image image-circle">
